...
| 3 | docdup | count of sim rows with `kind == 2` and `n * dupDen >= d * dupNum` ([Score.hs:143-144](../../../core/app/CE/Verdict/Score.hs#L143)) | files | `jaccardNum/jaccardDen = 80/100` ([Docdup/Cost.hs:27](../../../core/app/CE/Docdup/Cost.hs#L27), [Docdup/Cost.hs:30](../../../core/app/CE/Docdup/Cost.hs#L30)) |
...
| 6 | graph_cycle | count of pos rows with `sccSize >= cycleFloor` ([Score.hs:153-154](../../../core/app/CE/Verdict/Score.hs#L153)) | graph file nodes (pos rows) | `sccFloor = 2` ([Graph/Cost.hs:55](../../../core/app/CE/Graph/Cost.hs#L55)) |
