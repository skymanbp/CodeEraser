...
([mod.rs:135-139](../../../cli/src/join/mod.rs#L135)). Clone blocks are folded into that key as `(block count, token sum)` ([mod.rs:140-142](../../../cli/src/join/mod.rs#L140)).
...
Each side's position is `Pos { pIndeg, pReach, pFlags, pScc }` ([Join.hs:43-48](../../../core/app/CE/Verdict/Join.hs#L43)), decoded from the graph reply's `pos` rows `[indeg, outdeg, sccId, sccSize, reachIn]` ([mod.rs:34-38](../../../cli/src/join/mod.rs#L34), [mod.rs:113-127](../../../cli/src/join/mod.rs#L113)). Both sides are `Maybe`, and the pair is taken applicatively — either side missing kills the leg ([Join.hs:163-166](../../../core/app/CE/Verdict/Join.hs#L163)). Three predicates read it:
