...
| Markdown | relative join, the path percent-decoded after the `#` split; a directory holding in-scope files is a package ([md.rs:68-99](../../../cli/src/graph/ladder/md.rs#L68), [md.rs:120-134](../../../cli/src/graph/ladder/md.rs#L120)) | anchor, percent-decoded, validated against the target's anchor set — rendered-text ATX slugs plus raw-HTML anchor ids ([md.rs:140-155](../../../cli/src/graph/ladder/md.rs#L140), [md_slug.rs:36-51](../../../cli/src/graph/ladder/md_slug.rs#L36)) | reference-link definition substituted, chain rerun relabeled ([md.rs:159-191](../../../cli/src/graph/ladder/md.rs#L159)) | bare fragment = in-file section claim, taken as written ([md.rs:104-116](../../../cli/src/graph/ladder/md.rs#L104)) | any URI scheme or `//x` ⇒ External, a site-root `/x` ⇒ Unresolved(OutOfScope) ([md.rs:61](../../../cli/src/graph/ladder/md.rs#L61), [md.rs:69-74](../../../cli/src/graph/ladder/md.rs#L69)) |
...
- GitHub slugging: lowercase, keep alphanumerics/`_`/`-`, spaces→hyphens, everything else
  ...
  before the lookup ([md_slug.rs:251-276](../../../cli/src/graph/ladder/md_slug.rs#L251)); an indented
  ...
  ([md.rs:140-155](../../../cli/src/graph/ladder/md.rs#L140)).
...
([wire.rs:23-32](../../../cli/src/graph/wire.rs#L23), [Cost.hs:166-173](../../../core/app/CE/Graph/Cost.hs#L166)); granularity
...
role 0  base ∈ {main.rs, build.rs, main.go, __main__.py, Main.hs, main.c,
        ...
        server.R, global.R}, or init.lua at the root                [flags.rs:51-64, 88-90]
...
[flags.rs:83-118](../../../cli/src/graph/deadcode/flags.rs#L83)). The role→bit landing is the
