...
- **S1 band.** Runs land in the near sink when `len ∈ [near_floor, t)`. `near_floor = kgram = 25` and `t = guarantee() = window + kgram − 1 = 26 + 25 − 1 = 50` ([pairs.rs:248-253](../../../cli/src/dedup/pairs.rs#L248), [sources.rs:147-151](../../../cli/src/dedup/sources.rs#L147), [dedup/mod.rs:297-301](../../../cli/src/dedup/mod.rs#L297), defaults `kgram = 25, window = 26` at [dedup/mod.rs:305-313](../../../cli/src/dedup/mod.rs#L305)). `min_distinct = 0` for this pass ([sources.rs:149](../../../cli/src/dedup/sources.rs#L149)). S1 is **read-only** on the index — its writing predecessor silently re-hashed mid-run edits and orphaned their cascade-dropped edges ([sources.rs:136-138](../../../cli/src/dedup/sources.rs#L136)).
