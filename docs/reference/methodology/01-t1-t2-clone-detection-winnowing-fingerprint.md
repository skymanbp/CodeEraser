...
`literal_delims` is per-language because a delimiter in one grammar is an operator in another: TypeScript `["\"", "'", "`"]` ([spec.rs:225](../../../cli/src/scan/spec.rs#L225)), Go `["\"", "`"]` — `'` is the rune delimiter but `rune_literal` lexes as one token ([spec.rs:320](../../../cli/src/scan/spec.rs#L320)–[321](../../../cli/src/scan/spec.rs#L321)), Rust `["\""]` only, because `'` is the lifetime/label tick and classifying it as `LIT` made every `&'a str` signature a false clone driver ([spec.rs:271](../../../cli/src/scan/spec.rs#L271)–[273](../../../cli/src/scan/spec.rs#L273)), Python `[]` because quotes surface as named `string_start` / `string_end` kinds ([spec.rs:168](../../../cli/src/scan/spec.rs#L168)–[169](../../../cli/src/scan/spec.rs#L169)), Haskell `[]` because a string lexes as one `string` leaf with the quotes inside ([spec_hs.rs:69](../../../cli/src/scan/spec_hs.rs#L69)–[71](../../../cli/src/scan/spec_hs.rs#L71)).
