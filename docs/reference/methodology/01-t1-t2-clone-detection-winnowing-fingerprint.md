...
`literal_delims` is per-language because a delimiter in one grammar is an operator in another: TypeScript `["\"", "'", "`"]` ([spec.rs:197](../../../cli/src/scan/spec.rs#L197)), Go `["\"", "`"]` — `'` is the rune delimiter but `rune_literal` lexes as one token ([spec.rs:286](../../../cli/src/scan/spec.rs#L286)–[287](../../../cli/src/scan/spec.rs#L287)), Rust `["\""]` only, because `'` is the lifetime/label tick and classifying it as `LIT` made every `&'a str` signature a false clone driver ([spec.rs:240](../../../cli/src/scan/spec.rs#L240)–[242](../../../cli/src/scan/spec.rs#L242)), Python `[]` because quotes surface as named `string_start` / `string_end` kinds ([spec.rs:143](../../../cli/src/scan/spec.rs#L143)–[144](../../../cli/src/scan/spec.rs#L144)), Haskell `[]` because a string lexes as one `string` leaf with the quotes inside ([spec_hs.rs:69](../../../cli/src/scan/spec_hs.rs#L69)–[71](../../../cli/src/scan/spec_hs.rs#L71)).
