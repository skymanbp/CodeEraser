...
|---|---|---|---|---|---|---|---|
| self @ this commit | 1018 (1030 − 12 early-NUL) | rust | 2606 (1449) | 275 (0) | 10.6 % | 9 / 275 = 3.3 % | 9 / 2313 |
...
operator reads for the public surface: self rust <!--ce:restate:survival:self-this-commit:unmentioned-exported#paren-->0<!--/ce--> / <!--ce:restate:survival:self-this-commit:declared-exported#paren-->1449<!--/ce--> = <!--ce:restate:survival:self-this-commit:unmentioned-exported/declared-exported#paren-pct1-->0.0<!--/ce--> % (the suite is a reader of
