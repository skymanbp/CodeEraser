...
Each scored row goes out as `[i, j, inter, union]` with a parallel per-row verdict bit; the additive `counts.jaccardDups` counts the **Jaccard half only** ([Docdup.hs:111-121](../../../core/app/CE/Docdup.hs#L111), reply shape at [Docdup.hs:126-150](../../../core/app/CE/Docdup.hs#L126)).
