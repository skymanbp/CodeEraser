...
Each moved line is attributed to the innermost unit containing it — `owner` picks the minimum-span unit ([units.rs:177-182](../../../cli/src/fourclass/units.rs#L177)). Unit keys are `name/arity` for code ([units.rs:49-54](../../../cli/src/fourclass/units.rs#L49)) and heading text for Markdown ([units.rs:127-149](../../../cli/src/fourclass/units.rs#L127)). Non-function named units (Rust `const_item`, `static_item`, `struct_item`, `enum_item`, `trait_item`, `mod_item`; Python `class_definition`; TS/TSX class/interface/enum declarations) are registered only for relocation reporting, not for the M1 function metrics ([kinds.rs:14-36](../../../cli/src/fourclass/kinds.rs#L14)). Rust `impl_item` gets a typed key `impl Foo` / `impl Advisor for Foo` ([kinds.rs:46-51](../../../cli/src/fourclass/kinds.rs#L46), [units.rs:108-123](../../../cli/src/fourclass/units.rs#L108)) so that methods of different impls are not seen as top-level.
