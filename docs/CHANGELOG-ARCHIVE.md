...
> v1.3.2 及更早的版本条目。2026-08-31（v1.3.0 及更早）与 2026-09-05（v1.3.1–v1.3.2）
> 从 [CHANGELOG.md](../CHANGELOG.md) 迁出：
> 那一册抵到 750 行硬线，下一条版本条目会被守卫当场拒绝，按仓规「拆分优先于
> 豁免」拆分。条目逐字节搬家，未改写；记录义务与两类内容的定义仍由原册声明。
