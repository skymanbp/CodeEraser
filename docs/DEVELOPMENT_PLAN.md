...
> **版本** v2.20 · 2026-08-29 · 状态：🔒 已由 cc-memory 锁定 · **M0–M9 全交付（批 0 发 v0.7.3；批 1–9 与终扫落 main；v1.0.0 项目收口 2026-08-22）· K 轮已交付随 v1.2.0（2026-08-26）· L 轮 v2.20 在轨（v2.17 + 2026-08-28 修正案：减法批、测试子仓、二进制只出自 Actions；+ 2026-08-29 修正案：README 双语九节 + 仓内 demo、更新功能三面等价〔O83 逆转，§5.9 第二网络行为〕、三面等价门、文档三律）** · 本文件是本仓库唯一权威计划。修改流程：改本文件 → 重新 ccm 锁定 → 才能动代码。
