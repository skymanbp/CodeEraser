...
> **版本** v2.10 · 2026-08-21 · 状态：🔒 已由 cc-memory 锁定 · **M0–M8 全交付 · M9 收口令执行中（批 0 发 v0.7.3；批 1–9 落 main；终版 v1.0.0 项目收口）**
...
验收 = 产品判决面字节等价（上报集/退出码/报告行，golden 全绿）+每片反事实证表承重；wire 按 proto minor 加性演进。占比提升是副产品，禁止为占比写代码。全档：reviews/2026-08-17-adr-008-policy-dsl.md（git 历史）。
