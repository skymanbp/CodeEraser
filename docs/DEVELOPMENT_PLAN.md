...
> **版本** v2.23 · 2026-08-31 · 状态：🔒 已由 cc-memory 锁定 · **项目已结项（v2.22 收口令，2026-08-31）——三个具名后置束 45 条一次性裁定不做，此后只做维护（唯一例外 = CoC 递归增量——M1 起挂账、2026-08-26 台账看见却未立项、不在那 45 条内，2026-08-31 用户裁定复活并已走新 plan-set，细则 = ADR-008 第四期）** · **M0–M9 全交付（批 0 发 v0.7.3；批 1–9 与终扫落 main；v1.0.0 项目收口 2026-08-22）· K 轮已交付随 v1.2.0（2026-08-26）· L 轮 v2.21 **已交付**（v2.17 + 2026-08-28 修正案：减法批、测试子仓、二进制只出自 Actions；+ 2026-08-29 修正案：README 双语九节 + 仓内 demo、更新功能三面等价〔O83 逆转，§5.9 第二网络行为〕、三面等价门、文档三律；+ 2026-08-29 晚修正案 v2.21：ADR-009 文档事实派生 S1–S9 + archify 架构图；**v1.3.0 已于 2026-08-30 四渠道发布**〔tag 6da4463、GitHub Release 十资产、crates.io、codeeraser.dev 8/8、npm 1.3.0〕）** · 本文件是本仓库唯一权威计划。修改流程：改本文件 → 重新 ccm 锁定 → 才能动代码。
