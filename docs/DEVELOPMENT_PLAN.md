...
> **版本** v2.5 · 2026-08-20 · 状态：🔒 已由 cc-memory 锁定 · **M0–M8 全交付，v0.4.0 已发布（2026-08-19）**
...
|---|---|---|---|
| `size` | 文件 LOC；函数长度；参数个数 | 文件 300 警告 / 750 阻断（ESLint max-lines=300；Sonar S104=750）；函数 50/75（ESLint=50；Sonar S138=75）；参数 5（Pylint）。尺寸门语言臂（v2.5）：js/jsx/css/scss/less/html/vue/svelte/sh/yml 仅入本模块 + guard 硬预算 + 棘轮，不入任何判决族 | M1 |
