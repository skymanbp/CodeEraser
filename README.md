...
**This is the finished shape.** The three deferred bundles the plan's K–L row named — scoring and evaluation, distribution, and the evidence gates that would promote guard classes — were ruled not-done on 2026-08-31 (plan v2.22, 45 items). What follows is a list of positions, not a list of plans.
