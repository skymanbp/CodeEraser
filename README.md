...
- **One wire.** ce ↔ core is NDJSON over stdio with SemVer negotiation (proto <!--ce:ver:proto#v-->7.0.0<!--/ce-->, <!--ce:count:families#word-->twelve<!--/ce--> families); the per-project daemon speaks its own protocol (<!--ce:ver:daemon#v-->2.1.0<!--/ce-->) over `interprocess`; a protocol-major skew is a named refusal, never a guess.
