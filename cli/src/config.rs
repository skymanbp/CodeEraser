...
// The `[graph]` declarations — entry globs, crate roots, the cycle
// floor, the per-language search roots — judged at load like the
// rulepack (plan v2.30 step 2 split).
mod graph;
pub(crate) use graph::GraphCfg;
