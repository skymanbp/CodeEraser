...
`gui/` = 原 gui/tests 四节点门（主仓路径 `cli/tests/gui/*.js`，脚本 root 由两级改三级上溯）。**分数继续含测试**（用户裁）由 submodule 语义保证——步 #11 三处，加后续提交（2026-08-28；codex 中转站勘察 21 条经 Workflow 对抗核验：15 确认落码、6 驳回或无动作〔#6/#11/#13/#14/#19/#20〕）的 ④–⑩：
