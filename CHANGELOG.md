...
- 步 8 提交 4b18210 的 CI 33995985204 双平台唯一红腿仍是 `site_screenshots::the_pictures_are_no_older_than_the_screens_they_show`
...
- 步 8 修补提交 3e7b188 的 CI 33997942800 双平台唯一红腿 `eval_mention::the_self_corpus_holds_the_preregistered_zeros`：`scripts/shoot_receipt.js` 与子仓 `it/site_shots_receipt.rs`
